    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center bg-blue-50 p-3 rounded-lg border border-blue-100">
                  ...
                  <div className="text-right">
                    <a href={`tel:${order.customerPhone}`} className="text-xs bg-white px-3 py-1.5 rounded border border-blue-200 text-blue-600 font-medium hover:bg-blue-50 flex items-center gap-1">
      ...
      <div className="lg:col-span-1 space-y-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          ...
          <p className="text-sm text-gray-500 mb-4">10km radius from Home Kitchen HQ</p>
          {/* Mock Map View */}
